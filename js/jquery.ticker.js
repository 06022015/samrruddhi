    ...
    $.fn.breakingNews = function(params){
        ...
        return this.each(function(){
            ...
            function changeNews()
            {
                ...
                }/*else if(params.effect=="slide-hr"){
                    var n= params.modul.find(".breakingNews").width();
                    var r = {"rss-atom":{feedUrl:"", loadType:"direct"}, twitter:{twitterName:"", twitterLoadingFile:"modern-ticker/php/twitter.php"}};
                    var m = params.modul.find("ul");
                    var scrollType= "continuous";
                    r = setInterval(function () {
                            var r = parseFloat(m.css("margin-left"));
                            m.css("margin-left", r - 1);
                            if (r < 0 && Math.abs(r) > jQuery(m.children("li")[0]).outerWidth())m.css("margin-left", 0).children(":first").appendTo(m);
                    }, 20);
                }*/
            }
